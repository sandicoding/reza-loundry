...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">
  ...
  <body>
        ...
        <div id="collapsingNavbar" class="collapse navbar-toggleable-custom" role="tabpanel" aria-labelledby="collapsingNavbar">
          <ul class="nav navbar-nav pull-xs-right">
            <li class="nav-item nav-item-toggable">
              <a class="nav-link btn btn-primary" href="login/index.php">Masuk</a>
            </li>
    ...
    <header class="text-xs-center center-vertically" role="banner"
	style="background-image:url('./bg1.jpg'); background-size:cover;">
      <div class="container"> 
        <h1 style="font:bold 100px comic sans ms;
		-webkit-text-stroke: 2px black; color: blue; text shadow: 3px 3px 0#000, -1px -1px 0 #000,">Putri Laundry </h1> 
        <h2 style="font:bold 50px comic sans ms;
		-webkit-text-stroke: 2px black; color: blue; text shadow: 3px 3px 0#000, -1px -1px 0 #000," >Bersih, <em> Wangi</em>, dan Ekonomis <br><a href="ui-elements.html" class="jumbolink">
